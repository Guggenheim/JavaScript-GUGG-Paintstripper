...
b));return this},deactivate:function(){this.ps_shade.css({width:0}).find("img").removeClass("active");return this.element.removeClass("has-active")},max_zoom:function(){return 1/this.ps_ratio},move:function(b,a){if(void 0===b)return this.ps_base.position();a=void 0===a?this.options.move_duration:a;b=c.extend(this.ps_base.position(),b);c.each(this.ps_platens,function(){this.animate(b,a)});return this},ratio:function(){return this.ps_ratio},reset:function(b){var a=this.rotate(),b=void 0===b?0:b;this.reveal(0,
b);this.zoom(100,b);c.each(this.ps_platens,function(){c(this).css({top:0,left:0})});this.deactivate();180<a?this.rotate("+="+(360-a),b):this.rotate("-="+a,b);return this},reveal:function(b,a,c){var d=this.element,f=d.width(),g;if(!d.hasClass("has-active"))return this;if(void 0===b)return this.ps_shade.width();a=void 0===a?a=this.option.reveal_duration:a;"string"===typeof b&&null!==(g=b.match(/^(\d+)\%/))?b=f*(g[1]/100):"number"===typeof b&&(0>b?b=0:b>f&&(b=f));return this.ps_shade.animate({width:b},
{duration:a,easing:c,step:this._sync_handle,complete:this._sync_handle})},rotate:function(b,a,e){var d=this.element.find(".ps-axle");if(void 0===b)return parseInt(d.first().css("rotate"),10);a=void 0===a?this.options.rotate_duration:a;return d.each(function(){c(this).transition({rotate:b},a,e,function(b){var a=parseInt(c(this).css("rotate"),10);360<=a?c(this).css({rotate:a%360}):0>a&&c(this).css({rotate:a%360+360});void 0!==b&&b()})})},zoom:function(b,a){if(void 0===b)return this.ps_images.first().css("scale");
a=void 0===a?this.options.zoom_duration:a;c(".ps-platen img").each(function(){c(this).transition({scale:b/100},a)})},destroy:function(){},_activate_layer:function(b){b.addClass("active").siblings().removeClass("active");return b},_init_draggable:function(b){if(!1!==this.has_draggable){var a=this,e=b.offset().left,d=b.offset().top,f=e+b.width(),g=d+b.height(),h,i;b.append(a.ps_handle);h=a.ps_handle.outerWidth()/2;i=a.ps_handle.outerHeight()/2;a.ps_handle.css({left:-h,top:(b.height()-i)/2});a.ps_handle.draggable({axis:"x",
containment:[e-h,d,f-h,g],drag:function(b,c){var d=c.position.left,e=c.helper.outerWidth()/2;a.ps_shade.width(d+e)}});c.each([a.ps_base,a.ps_platen],function(){c(this).draggable({drag:function(b,a){c(".ps-platen").css({top:a.position.top,left:a.position.left})}})});return b}},_save_style:function(b){return c.each(b,function(){void 0===c(this).attr("style")?c(this).data("orig-style",c(this).attr("style")):c(this).data("orig-style",null)})},_sync_handle:function(){var b=c(this),a=b.siblings(".ps-handle").first(),
e=b.width(),b=b.closest(".ps-paintstripper").width();0>e?e=0:e>b&&(e=b);0<a.length&&a.css({left:e-a.outerWidth()/2});return this}})})(jQuery);
